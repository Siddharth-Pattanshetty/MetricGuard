...
│   └── backend/                        #    Service layers and business logic
│
...
│   └── testing/                        #    Stress tests, agent verification, and RCA tests
...
```bash
python -m pytest tests/testing/anomaly_test.py -v
```

#### Run specific categories:

```bash
python -m pytest tests/testing/anomaly_test.py::TestCPUStress -v
python -m pytest tests/testing/anomaly_test.py::TestRAMStress -v
python -m pytest tests/testing/anomaly_test.py::TestFakeAnomaly -v
python -m pytest tests/testing/anomaly_test.py::TestFullCollection -v
```
...
```bash
python -m pytest tests/testing/agent_test.py -v
```

#### Run specific categories:

```bash
python -m pytest tests/testing/agent_test.py::TestAgentLogHealth -v
python -m pytest tests/testing/agent_test.py::TestBackendHealth -v
python -m pytest tests/testing/agent_test.py::TestAnomalyLogging -v
python -m pytest tests/testing/agent_test.py::TestCollectorModule -v
python -m pytest tests/testing/agent_test.py::TestAgentLogActivity -v
python -m pytest tests/testing/agent_test.py::TestLiveAgentCycle -v
```

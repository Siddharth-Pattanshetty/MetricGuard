...
How to run:
    python -m pytest tests/testing/rca_test.py -v

    Or run individual test classes:
    python -m pytest tests/testing/rca_test.py::TestSpeedParser -v
    python -m pytest tests/testing/rca_test.py::TestFeatureExtraction -v
    python -m pytest tests/testing/rca_test.py::TestAutoencoderInference -v
    python -m pytest tests/testing/rca_test.py::TestRCALogic -v
    python -m pytest tests/testing/rca_test.py::TestRCAEndpoints -v
...
# docs/legacy_monitoring/realtime_ai_detection.py and have not been
...
MONITORING_DIR = os.path.join(PROJECT_ROOT, "docs", "legacy_monitoring")
